                ...
                <div class="col-md-12 d-md-flex align-items-md-center">
                    <div class="py-4 py-md-0 text-center text-md-left invisible" data-toggle="appear">
						<div class="alert alert-danger" role="alert">
                                        <p class="mb-0">Welcome to TapDispenser <a class="alert-link" href="#">Your #1 Account Dispenser</a> !</p>
                                    </div>
          ...
          <div class="block block-rounded block-mode-loading-refresh">
              ...
              <div class="block-content">
			   <!-- Your Twitter Account -->
                  <a class="twitter-timeline"  data-height="600" data-lang="fr" href="https://twitter.com/TapTweaker">Tweets by TapDispenser</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
              </div>
          </div>
      </div>
      <div class="col-xl-6 invisible" data-toggle="appear">
              ...
              <div class="block-content">
                  ...
                  <script type="text/javascript">
                      new Twitch.Embed("twitch-embed", {
                          width: 1200,
                          height: 480,
                          channel: "TapTM", // Your Twitch Channel
                          layout: "video",
                          width: "100%",
                          theme: "dark"
                      });
