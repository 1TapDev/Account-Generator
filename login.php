...
<html lang="en">
    <head>
		...
		<meta name="description" content="TapDispenser your #1 Account dispenser template">
        <meta name="author" content="TapDispenser">
            ...
            <div class="p-3 w-100">
                ...
                <div class="mb-3 text-center">
                    <a class="link-fx font-w700 font-size-h1">
                        <span class="text-dark">Tap</span><span class="text-primary">Dispenser</span>
                    </a>
        ...
        <div class="hero-static col-md-6 d-none d-md-flex align-items-md-center justify-content-md-center text-md-center">
            <div class="p-3">
                <p class="display-4 font-w700 text-white mb-3">
                    Welcome to TapDispenser your #1 Best Dispenser of all time!
                </p>
                <p class="font-size-lg font-w600 text-white-75 mb-0">
                    Copyright &copy; <span class="js-year-copy">2017-2019</span>
                </p>
            </div>
        </div>
