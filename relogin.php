            ...
            <div class="p-3 w-100">
                ...
                <div class="text-center">
                    <a class="link-fx text-danger font-w700 font-size-h1" href="index.php">
                        <span class="text-dark">Tap</span><span class="text-danger">Dispenser</span>
                    </a>
                    <p class="text-uppercase font-w700 font-size-sm text-muted">Lock Screen</p>
                </div>
                <!-- END Header -->
                      ...
                      ?>
                        <form class="js-validation-lock" method="post">
                            <div class="form-group py-3">
                                <input type="password" class="form-control form-control-lg form-control-alt" id="lock-password" name="login-password" placeholder="Password..">
                            </div>
                            ...
                            <div class="form-group text-center">
                                ...
                                <p class="mt-3 mb-0 d-lg-flex justify-content-lg-between">
                                    <!--<a class="btn btn-sm btn-light d-block d-lg-inline-block mb-1" href="reminder.php">
                                        <i class="fa fa-exclamation-triangle text-muted mr-1"></i> Forgot your password
                                    </a>-->
